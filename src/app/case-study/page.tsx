...
export default function CaseStudyPage() {
  return <>
    ...
    <p className="lede">An evidence-grounded marketing intelligence prototype combining deterministic analytics, verified qualitative evidence and bounded AI interpretation.</p>
    ...
    <hr className="rule" />
    <section><p className="section-label">How the system works</p><h2>Interpretation sits above evidence.</h2><div className="architecture-flow" aria-label="System architecture flow"><div className="flow-pipelines"><div className="flow-source"><span>Marketing observations</span><b>↓</b><span>Deterministic analytics</span><b>↓</b><span>Trend + anomaly evidence</span></div><div className="flow-source"><span>Synthetic customer feedback</span><b>↓</b><span>AI classification</span><b>↓</b><span>Deterministic provenance verification</span><b>↓</b><span>Verified qualitative evidence</span></div></div><b className="flow-arrow">↓</b><div className="flow-merge"><strong>Evidence layer</strong></div><b className="flow-arrow">↓</b><div className="flow-output"><span>Evidence package</span><b>↓</b><span>AI interpretation</span><b>↓</b><span>Deterministic output verification</span><b>↓</b><span>Analyst brief + canonical evidence</span></div></div></section>

    <hr className="rule" />
    <section className="case-dual"><div><p className="section-label">AI is used for</p><ul className="case-list"><li>Classifying qualitative customer language and selecting a short supporting excerpt</li><li>Interpreting a bounded evidence package</li><li>Generating concise, evidence-linked analyst narrative</li></ul></div><div><p className="section-label">AI is not used for</p><ul className="case-list"><li>KPI, aggregation, trend or anomaly calculations</li><li>Analyst evidence-package retrieval, quantitative evidence selection or canonical numeric facts</li><li>Causal attribution, database actions or campaign optimisation</li></ul></div></section>
